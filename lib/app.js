...
async function createApp() {
  ...
  app.get('/api/frame/:code/geometria', async (req, res) => {
    ...
    if (!daSessao && geometriaEmCache !== undefined) {
      return res.json(geometriaEmCache || { temMoldura: false });
    }
    ...
    try {
      ...
      if (!buffer) {
        if (!daSessao) geometriaEmCache = null;
      ...
      if (!daSessao) geometriaEmCache = resposta;
      res.json(resposta);
    } catch (err) {
