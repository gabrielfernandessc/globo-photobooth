...
async function createApp() {
  ...
  /* Preview do celular. Vive só em memória e é descartável por
     definição: a fotografia sobe por outro caminho, em resolução plena. */
  ...
  app.get('/api/preview/:code/stream', (req, res) => {
    ...
    const cancelar = preview.assinar(code, jpeg => res.write(quadroMjpeg(jpeg)));
  ...
  return { app, server, io, store, storage, repo, shareQueue, event };
}
