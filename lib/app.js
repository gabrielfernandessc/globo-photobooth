...
const {
  initStore, getStore, getRedisClients, generateCode, normalizeCode, newSession,
...
async function createApp() {
  ...
  /**
   * O registro em memória some quando a requisição cai noutra instância,
   * e é justamente o convidado escaneando o QR que costuma cair noutra.
   * Por isso o nome do arquivo é determinístico: dá para reconstruir a
   * foto a partir do id, sem consultar estado nenhum.
   */
